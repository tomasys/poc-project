...
/* 프로젝트 */
AppProperties.prototype.PROJECT_NM = "woori-bank-poc-" // 프로젝트명
...
/* 메인 */
AppProperties.prototype.MAIN_APP_ID  = "app/main/Main";	// 메인 app id
...
AppProperties.prototype.MAIN_DUPL_LOGIN_ALLOWED = true; // 중복 로그인 허용여부

/* 조회조건 */
AppProperties.prototype.SEARCH_BTN_ID = "btnSearch";	// 공통 조회 버튼 ID (조회조건 초기화에서 사용)

/* 그리드 */
AppProperties.prototype.GRID_INDEX_COL_HEADER_TEXT = "순번";	// 그리드 columnType이 rowindex인 컬럼의 헤더 텍스트
AppProperties.prototype.GRID_STATE_COL_HEADER_TEXT = ["상태","F"];	// 그리드 로우의 CRUD를 표시하는 컬럼의 헤더 텍스트

/* 다이얼로그 */
AppProperties.prototype.DIALOG_MAX_HEIGHT = 900; // 자동높이 사용시(height : -1) 다이얼로그 최대 높이

/* 유효성 체크 */
AppProperties.prototype.M_REQUIRED_STYLE = ",required," ;	// 필수 css class명  ",(콤마)로 분리하며 처음과 마지막에 콤마가 꼭있어야 합니다.
...
/* Docs View Type */
AppProperties.prototype.DOCS_VIEW_TYPE = "pdf" // 장표 표시 타입("pdf", "image")
